...
class Engine:
    def __init__(self, args):
        ...
        if args.inference == 0:
            print('Training data....')
            train_loader = data_loader(args.data, 'train', args.topic, args.batch_size, model=args.model,wiki_model=args.wiki_model, n_workers=args.n_workers)
            print('Val data....')
    ...
    def train_epoch(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            if self.args.wiki_model and self.args.wiki_model != self.args.model: #NOT VAST
            ...
            logits = self.model(input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids,
                                input_ids_wiki=input_ids_wiki, attention_mask_wiki=attention_mask_wiki, input_ids_senti = input_ids_senti, attention_mask_senti= attention_mask_senti)
